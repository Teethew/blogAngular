                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-b6607e191c8454ddae7d7511c4e270c5"' : 'data-target="#xs-components-links-module-AppModule-b6607e191c8454ddae7d7511c4e270c5"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-b6607e191c8454ddae7d7511c4e270c5"' :
                                            'id="xs-components-links-module-AppModule-b6607e191c8454ddae7d7511c4e270c5"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DeletePostagensComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DeletePostagensComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PutPostagensComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PutPostagensComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/PostagensService.html" data-type="entity-link">PostagensService</a>
                                </li>
                                <li class="link">
